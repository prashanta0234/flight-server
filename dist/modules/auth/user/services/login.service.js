...
var UserLoginService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var email, password, isExists, isPasswordMatch, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                isExists = _a.sent();
                if (!isExists) {
                    throw (0, error_maker_1.ErrorMaker)("Not found", "Sorry you are not registered.", 404);
                }
                return [4 /*yield*/, bcrypt_1.default.compare(password, isExists.password)];
            case 2:
                isPasswordMatch = _a.sent();
                if (!isPasswordMatch) {
                    throw (0, error_maker_1.ErrorMaker)("Not match", "Sorry you`r given password not matched.", 400);
                }
